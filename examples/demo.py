...
shield_cd = CooldownOverlay(
    shield_timer, 40, overlay_color=(255, 255, 255, 80), border_color=(255, 200, 60), border_width=2, border_radius=4
)
...
while running:
    ...
    instr_surf = render_multiline(
        small,
        "Arrows: move | D/S: cooldowns | T: transition | Q: quit",
        (130, 130, 150),
        max_width=600,
        align="center",
    )
